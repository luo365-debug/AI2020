from yolov4_traffic.models import Darknet    # YOLOv4网络结构的实现
from yolov4_traffic.utils.datasets import *  # 引入所有数据集处理函数
from yolov4_traffic.utils.utils import *     # 引入yolo的计算函数：比如iou计算
...
class TrafficDetector:
    ...
    def __init__(self):
        ...
        self.mod_file = os.path.join(current_dir, "data/home.pt")
        self.names_file = os.path.join(current_dir, "data/home.names")
